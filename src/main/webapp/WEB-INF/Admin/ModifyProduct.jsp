...
<body>
	<div class="col-md-8">
		<form:form action="ModifyProductform" class="well form-horizontal"
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="input-group">
						<form:input type="text" name="ProdId" path="Id" readonly="true"
			...
			<div class="row">
				<div class="col-md-6">
					<label for="name" class="control-label"><h4>Category
							Id</h4></label>
				</div>
				<div class="col-md-4">
			...
			<div class="row">
				<div class="col-md-6">
					<label for="name" class="control-label"><h4>Supplier
							Id</h4></label>
				</div>
				<div class="col-md-4">
					<div class="input-group">
			...
			<div class="row">
				<div class="col-md-6">
					<label for="name" class="control-label"><h4>Product
							Price</h4></label>
				</div>
				<div class="col-md-4">
					<div class="input-group">
						<form:input type="text" placeholder="Product Name"
							name="ProdPrice" path="price" class="form-control input-lg"></form:input>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="input-group">
						<form:input type="text" placeholder="Product Name"
							name="ProdStock" path="stock" class="form-control input-lg"></form:input>
					</div>
				</div>
			</div>
		...
		<%-- 	<div class="row">
				<div class="col-md-6">
					<label for="name" class="control-label"><h4>Upload
							Image</h4></label>
				</div>
				<div class="col-md-4">
					<div class="input-group">
